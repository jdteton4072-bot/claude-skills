...
- [pulser](./pulser/) - Diagnose, classify, prescribe, and fix Claude Code SKILL.md files against 8 rules derived from Anthropic's published principles. Auto-classification, ready-to-use templates, `--fix` with rollback. *By [@whynowlab](https://github.com/whynowlab)*
