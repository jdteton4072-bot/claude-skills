...
- [Jarvis Orb](https://github.com/whynowlab/jarvis-orb) - Persistent 4-tier AI memory with temporal scoring, contradiction detection, entity tracking, and real-time desktop visualization orb via MCP. *By [@whynowlab](https://github.com/whynowlab)*
