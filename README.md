...
- [Claude Code Starter Kit](https://github.com/rmbell09-lang/claude-code-starter-kit) - Production-ready workspace boilerplate for persistent Claude Code agents: SOUL.md, AGENTS.md, MEMORY.md templates + 5 battle-tested skills. Drop in and ship. *By [@rmbell09-lang](https://github.com/rmbell09-lang)*
