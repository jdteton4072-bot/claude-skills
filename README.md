...
- [Schliff](https://github.com/Zandereins/schliff) - Deterministic quality linter for SKILL.md files — scores skill quality, detects score-inflation patterns, and autonomously improves skills to production grade. *By [@Zandereins](https://github.com/Zandereins)*
