...
- [kasetto](https://github.com/pivoshenko/kasetto) - An extremely fast AI skills manager that syncs skills from GitHub repos into agent environments like Claude Code, Cursor, and Codex.
